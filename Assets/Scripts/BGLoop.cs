...
public class BGLoop : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        bg2.transform.position = new Vector3(bg1.transform.position.x,
                                             bg1.transform.position.y + m_ySize,
                                             0f);
    }
    private void Update()
    {
        ...
        {
            bg1.transform.position = new Vector3(bg2.transform.position.x,
